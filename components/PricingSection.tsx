...
const features: PricingFeature[] = [
  { name: "Telegram-based updates", included: "starter" },
  { name: "Up to 100 updates/month", included: "starter" },
  { name: "Basic AI processing", included: "starter" },
  { name: "Email support", included: "starter" },
  { name: "Advanced intent recognition", included: "pro" },
  { name: "Up to 1,000 updates/month", included: "pro" },
  { name: "Customer chat integration", included: "pro" },
  { name: "Priority support", included: "pro" },
  { name: "Custom business logic", included: "enterprise" },
  { name: "Unlimited updates", included: "enterprise" },
  ...
  { name: "Multi-location support", included: "all" },
];
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="font-figtree text-lg text-muted-foreground max-w-2xl mx-auto">
            Get started with Auralink's communication intelligence platform. All
