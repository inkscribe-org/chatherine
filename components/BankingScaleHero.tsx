...
const stats: StatItem[] = [
  ...
  {
    value: "1000+",
    description: "Small businesses\nhelped by Chatherine",
    delay: 0.4,
  },
  {
    value: "Instant",
    description: "Updates via\nTelegram messages",
    delay: 0.6,
  },
];
      ...
      <div className="mx-auto max-w-7xl px-8 py-24 pt-16">
        <div className="grid grid-cols-12 gap-5 gap-y-16">
          <div className="col-span-12 md:col-span-6 relative z-10">
            ...
            >
              Small businesses struggle to maintain their digital tools{" "}
              <span
              ...
              >
                leading to outdated chatbots that become unusable within weeks.
              </span>
            </h2>
            ...
            >
              Chatherine solves this by allowing business owners to update their
              AI assistants simply by sending messages through Telegram, using
              Google Gemini AI for instant processing.
            </p>
