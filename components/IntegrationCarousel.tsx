...
export const IntegrationCarousel = ({
  ...
  buttonHref = "#",
  title = "Powered by cutting-edge AI technologies.",
  subtitle = "Chatherine uses Google Gemini AI, Telegram, and enterprise-grade orchestration to deliver instant updates.",
