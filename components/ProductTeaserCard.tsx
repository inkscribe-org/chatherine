...
export const ProductTeaserCard = (props: ProductTeaserCardProps) => {
  const {
    dailyVolume = "1000+",
    dailyVolumeLabel = "SMALL BUSINESSES SERVED",
    headline = "The AI Assistant That Updates Itself",
    subheadline = "Enterprise-grade AI for small business owners. Update your assistant via Telegram messages instead of dashboards.",
    description = "Chatherine uses Google Gemini AI to instantly process natural language updates, keeping your business information current without technical skills required.",
